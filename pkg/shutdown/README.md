...
```
go get iamgeek/pkg/shutdown
```

## Documentation

`iamgeek/pkg/shutdown` documentation is available on [godoc](http://godoc.org/iamgeek/pkg/shutdown).

Both `ShutdownManagers` are also documented:
- [`PosixSignalManager`](http://godoc.org/iamgeek/pkg/shutdown/shutdownmanagers/posixsignal)
- [`AwsManager`](http://godoc.org/iamgeek/pkg/shutdown/shutdownmanagers/awsmanager)
...
import (
	...
	"iamgeek/pkg/shutdown/shutdownmanagers/awsmanager"
